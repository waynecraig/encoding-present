...
var A = 'ok';
// var A = 'a><script></script><a';
// var A = 'input onmouseover=alert(1)';
return '<{{A}}></{{A}}>'.replace(/{{A}}/g, A);
//return '<{{A}}/>'.replace(/{{A}}/g, A);`;

		this.state.codeArt = this._codeArt = `// Art-template
var A = 'ok';
// var A = 'a><script></script><a';
// var A = 'input onmouseover=alert(1)';
var render = ArtTemplate.compile('<{{A}}></{{A}}>');
//var render = ArtTemplate.compile('<{{A}}/>');
return render({A:A});`;
...
// var A = 'a><script></script><a';
// var A = 'input onmouseover=alert(1)';
return React.renderToString(React.createElement(A));
// equal to <A></A> or <A/>
